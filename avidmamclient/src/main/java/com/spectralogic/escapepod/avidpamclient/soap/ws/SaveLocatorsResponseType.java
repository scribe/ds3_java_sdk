...
/**
 * The response from the SaveLocators operation. Errors contains a
 * list of errors that occurred.
 *         If there are no errors, the Errors element is omitted entirely.
 * A list of Locator IDs will be returned. If a
 *         given locator could not be added, then the corresponding spot
 * in the response will be nil.
 */
public class SaveLocatorsResponseType  implements java.io.Serializable, org.apache.axis.encoding.AnyContentType {
    ...
    public SaveLocatorsResponseType() {
    }
    ...
    /**
     * Gets the errors value for this SaveLocatorsResponseType.
     * 
     * @return errors
     */
    ...
    /**
     * Sets the errors value for this SaveLocatorsResponseType.
     * 
     * @param errors
     */
    ...
    /**
     * Gets the results value for this SaveLocatorsResponseType.
     * 
     * @return results
     */
    ...
    /**
     * Sets the results value for this SaveLocatorsResponseType.
     * 
     * @param results
     */
    ...
    /**
     * Gets the extension value for this SaveLocatorsResponseType.
     * 
     * @return extension
     */
    ...
    /**
     * Sets the extension value for this SaveLocatorsResponseType.
     * 
     * @param extension
     */
    ...
    /**
     * Gets the _any value for this SaveLocatorsResponseType.
     * 
     * @return _any
     */
    ...
    /**
     * Sets the _any value for this SaveLocatorsResponseType.
     * 
     * @param _any
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof SaveLocatorsResponseType)) return false;
        SaveLocatorsResponseType other = (SaveLocatorsResponseType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(SaveLocatorsResponseType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://avid.com/interplay/ws/assets/types", "SaveLocatorsResponseType"));
