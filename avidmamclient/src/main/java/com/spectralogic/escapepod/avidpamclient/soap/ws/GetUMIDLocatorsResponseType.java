/**
 * GetUMIDLocatorsResponseType.java
 *
...
/**
 * The response from the GetUMIDLocators operation. Errors contains
 * a list of errors that
 *         occurred. If there are no errors, the Errors element is omitted
 * entirely. If the operation is successful, a list
 *         of UMID Locators will be returned.
 */
public class GetUMIDLocatorsResponseType  implements java.io.Serializable, org.apache.axis.encoding.AnyContentType {
    private com.spectralogic.escapepod.avidpamclient.soap.ws.ErrorType[] errors;

    private com.spectralogic.escapepod.avidpamclient.soap.ws.UMIDLocatorType[] results;

    private com.spectralogic.escapepod.avidpamclient.soap.ws.ExtensionType extension;

    private org.apache.axis.message.MessageElement [] _any;

    public GetUMIDLocatorsResponseType() {
    }

    public GetUMIDLocatorsResponseType(
           com.spectralogic.escapepod.avidpamclient.soap.ws.ErrorType[] errors,
           com.spectralogic.escapepod.avidpamclient.soap.ws.UMIDLocatorType[] results,
    ...
    /**
     * Gets the errors value for this GetUMIDLocatorsResponseType.
     * 
     * @return errors
     */
    ...
    /**
     * Sets the errors value for this GetUMIDLocatorsResponseType.
     * 
     * @param errors
     */
    ...
    /**
     * Gets the results value for this GetUMIDLocatorsResponseType.
     * 
     * @return results
     */
    public com.spectralogic.escapepod.avidpamclient.soap.ws.UMIDLocatorType[] getResults() {
        return results;
    }


    /**
     * Sets the results value for this GetUMIDLocatorsResponseType.
     * 
     * @param results
     */
    public void setResults(com.spectralogic.escapepod.avidpamclient.soap.ws.UMIDLocatorType[] results) {
        this.results = results;
    }


    /**
     * Gets the extension value for this GetUMIDLocatorsResponseType.
     * 
     * @return extension
     */
    ...
    /**
     * Sets the extension value for this GetUMIDLocatorsResponseType.
     * 
     * @param extension
     */
    ...
    /**
     * Gets the _any value for this GetUMIDLocatorsResponseType.
     * 
     * @return _any
     */
    ...
    /**
     * Sets the _any value for this GetUMIDLocatorsResponseType.
     * 
     * @param _any
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetUMIDLocatorsResponseType)) return false;
        GetUMIDLocatorsResponseType other = (GetUMIDLocatorsResponseType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetUMIDLocatorsResponseType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://avid.com/interplay/ws/assets/types", "GetUMIDLocatorsResponseType"));
