...
/**
 * The response from the GetLatest operation. Errors contains a list
 * of errors that occurred. If
 *         there are no errors, the Errors element is omitted entirely.
 * File is the binary representation of the requested
 *         asset. The File element will be omitted if errors caused the
 * operation to fail.
 */
public class GetLatestResponseType  implements java.io.Serializable, org.apache.axis.encoding.AnyContentType {
    ...
    /**
     * Gets the errors value for this GetLatestResponseType.
     * 
     * @return errors
     */
    ...
    /**
     * Sets the errors value for this GetLatestResponseType.
     * 
     * @param errors
     */
    ...
    /**
     * Gets the file value for this GetLatestResponseType.
     * 
     * @return file
     */
    public byte[] getFile() {
    ...
    /**
     * Sets the file value for this GetLatestResponseType.
     * 
     * @param file
     */
    ...
    /**
     * Gets the extension value for this GetLatestResponseType.
     * 
     * @return extension
     */
    ...
    /**
     * Sets the extension value for this GetLatestResponseType.
     * 
     * @param extension
     */
    ...
    /**
     * Gets the _any value for this GetLatestResponseType.
     * 
     * @return _any
     */
    ...
    /**
     * Sets the _any value for this GetLatestResponseType.
     * 
     * @param _any
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetLatestResponseType)) return false;
        GetLatestResponseType other = (GetLatestResponseType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetLatestResponseType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://avid.com/interplay/ws/assets/types", "GetLatestResponseType"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://avid.com/interplay/ws/assets/types", "File"));
