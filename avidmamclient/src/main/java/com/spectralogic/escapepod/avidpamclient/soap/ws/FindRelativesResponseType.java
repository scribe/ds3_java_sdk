/**
 * FindRelativesResponseType.java
 *
...
/**
 * The response from the FindRelatives operation. Errors contains
 * a list of errors that occurred.
 *         If there are no errors, the Errors element is omitted entirely.
 * Results contains a list of assets that are
 *         relatives along with metadata. The Results element will be
 * omitted if errors caused the entire operation to fail
 *         completely.
 */
public class FindRelativesResponseType  implements java.io.Serializable, org.apache.axis.encoding.AnyContentType {
    ...
    public FindRelativesResponseType() {
    }
    ...
    /**
     * Gets the errors value for this FindRelativesResponseType.
     * 
     * @return errors
     */
    ...
    /**
     * Sets the errors value for this FindRelativesResponseType.
     * 
     * @param errors
     */
    ...
    /**
     * Gets the results value for this FindRelativesResponseType.
     * 
     * @return results
     */
    ...
    /**
     * Sets the results value for this FindRelativesResponseType.
     * 
     * @param results
     */
    ...
    /**
     * Gets the extension value for this FindRelativesResponseType.
     * 
     * @return extension
     */
    ...
    /**
     * Sets the extension value for this FindRelativesResponseType.
     * 
     * @param extension
     */
    ...
    /**
     * Gets the _any value for this FindRelativesResponseType.
     * 
     * @return _any
     */
    ...
    /**
     * Sets the _any value for this FindRelativesResponseType.
     * 
     * @param _any
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof FindRelativesResponseType)) return false;
        FindRelativesResponseType other = (FindRelativesResponseType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(FindRelativesResponseType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://avid.com/interplay/ws/assets/types", "FindRelativesResponseType"));
