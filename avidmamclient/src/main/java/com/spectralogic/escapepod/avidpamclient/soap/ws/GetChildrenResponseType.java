...
/**
 * The response from the GetChildren operation. Errors contains a
 * list of errors that occurred. If
 *         there are no errors, the Errors element is omitted entirely.
 * Results contains a list of resulting nodes along
 *         with a predefined set of basic metadata. The Results element
 * will be omitted if errors caused the entire
 *         operation to fail completely.
 */
public class GetChildrenResponseType  implements java.io.Serializable, org.apache.axis.encoding.AnyContentType {
    ...
    public GetChildrenResponseType() {
    }
    ...
    /**
     * Gets the errors value for this GetChildrenResponseType.
     * 
     * @return errors
     */
    ...
    /**
     * Sets the errors value for this GetChildrenResponseType.
     * 
     * @param errors
     */
    ...
    /**
     * Gets the results value for this GetChildrenResponseType.
     * 
     * @return results
     */
    ...
    /**
     * Sets the results value for this GetChildrenResponseType.
     * 
     * @param results
     */
    ...
    /**
     * Gets the extension value for this GetChildrenResponseType.
     * 
     * @return extension
     */
    ...
    /**
     * Sets the extension value for this GetChildrenResponseType.
     * 
     * @param extension
     */
    ...
    /**
     * Gets the _any value for this GetChildrenResponseType.
     * 
     * @return _any
     */
    ...
    /**
     * Sets the _any value for this GetChildrenResponseType.
     * 
     * @param _any
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetChildrenResponseType)) return false;
        GetChildrenResponseType other = (GetChildrenResponseType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetChildrenResponseType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://avid.com/interplay/ws/assets/types", "GetChildrenResponseType"));
