/**
 * CreateSubclipResponseType.java
 *
...
/**
 * The response from the CreateSubclip operation. Errors contains
 * a list of errors that occurred.
 *         If there are no errors, the Errors element is omitted entirely.
 * The InterplayURI represents a reference to the
 *         new subclip (by mob ID). The InterplayURI element will be
 * omitted if errors caused the operation to fail.
 */
public class CreateSubclipResponseType  implements java.io.Serializable, org.apache.axis.encoding.AnyContentType {
    ...
    public CreateSubclipResponseType() {
    }
    ...
    /**
     * Gets the errors value for this CreateSubclipResponseType.
     * 
     * @return errors
     */
    ...
    /**
     * Sets the errors value for this CreateSubclipResponseType.
     * 
     * @param errors
     */
    ...
    /**
     * Gets the interplayURI value for this CreateSubclipResponseType.
     * 
     * @return interplayURI
     */
    ...
    /**
     * Sets the interplayURI value for this CreateSubclipResponseType.
     * 
     * @param interplayURI
     */
    ...
    /**
     * Gets the extension value for this CreateSubclipResponseType.
     * 
     * @return extension
     */
    ...
    /**
     * Sets the extension value for this CreateSubclipResponseType.
     * 
     * @param extension
     */
    ...
    /**
     * Gets the _any value for this CreateSubclipResponseType.
     * 
     * @return _any
     */
    ...
    /**
     * Sets the _any value for this CreateSubclipResponseType.
     * 
     * @param _any
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CreateSubclipResponseType)) return false;
        CreateSubclipResponseType other = (CreateSubclipResponseType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CreateSubclipResponseType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://avid.com/interplay/ws/assets/types", "CreateSubclipResponseType"));
