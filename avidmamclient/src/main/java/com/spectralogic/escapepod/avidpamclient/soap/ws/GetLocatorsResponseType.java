...
/**
 * The response from the GetLocators operation. Errors contains a
 * list of errors that occurred. If
 *         there are no errors, the Errors element is omitted entirely.
 * If the operation is successful, a list of Locators
 *         will be returned.
 */
public class GetLocatorsResponseType  implements java.io.Serializable, org.apache.axis.encoding.AnyContentType {
    private com.spectralogic.escapepod.avidpamclient.soap.ws.ErrorType[] errors;

    private com.spectralogic.escapepod.avidpamclient.soap.ws.LocatorType[] results;

    private com.spectralogic.escapepod.avidpamclient.soap.ws.ExtensionType extension;

    private org.apache.axis.message.MessageElement [] _any;

    public GetLocatorsResponseType() {
    }

    public GetLocatorsResponseType(
           com.spectralogic.escapepod.avidpamclient.soap.ws.ErrorType[] errors,
           com.spectralogic.escapepod.avidpamclient.soap.ws.LocatorType[] results,
    ...
    /**
     * Gets the errors value for this GetLocatorsResponseType.
     * 
     * @return errors
     */
    ...
    /**
     * Sets the errors value for this GetLocatorsResponseType.
     * 
     * @param errors
     */
    ...
    /**
     * Gets the results value for this GetLocatorsResponseType.
     * 
     * @return results
     */
    public com.spectralogic.escapepod.avidpamclient.soap.ws.LocatorType[] getResults() {
        return results;
    }


    /**
     * Sets the results value for this GetLocatorsResponseType.
     * 
     * @param results
     */
    public void setResults(com.spectralogic.escapepod.avidpamclient.soap.ws.LocatorType[] results) {
        this.results = results;
    }


    /**
     * Gets the extension value for this GetLocatorsResponseType.
     * 
     * @return extension
     */
    ...
    /**
     * Sets the extension value for this GetLocatorsResponseType.
     * 
     * @param extension
     */
    ...
    /**
     * Gets the _any value for this GetLocatorsResponseType.
     * 
     * @return _any
     */
    ...
    /**
     * Sets the _any value for this GetLocatorsResponseType.
     * 
     * @param _any
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetLocatorsResponseType)) return false;
        GetLocatorsResponseType other = (GetLocatorsResponseType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetLocatorsResponseType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://avid.com/interplay/ws/assets/types", "GetLocatorsResponseType"));
