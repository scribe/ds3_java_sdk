...
/**
 * The response from the FindLinks operation. Errors contains a list
 * of errors that occurred. If
 *         there are no errors, the Errors element is omitted entirely.
 * The Results are a list of path-based InterplayURIs
 *         referencing each link to the asset. The Results element will
 * be omitted if errors caused the entire operation to
 *         fail.
 */
public class FindLinksResponseType  implements java.io.Serializable, org.apache.axis.encoding.AnyContentType {
    ...
    /**
     * Gets the errors value for this FindLinksResponseType.
     * 
     * @return errors
     */
    ...
    /**
     * Sets the errors value for this FindLinksResponseType.
     * 
     * @param errors
     */
    ...
    /**
     * Gets the results value for this FindLinksResponseType.
     * 
     * @return results
     */
    ...
    /**
     * Sets the results value for this FindLinksResponseType.
     * 
     * @param results
     */
    ...
    /**
     * Gets the extension value for this FindLinksResponseType.
     * 
     * @return extension
     */
    ...
    /**
     * Sets the extension value for this FindLinksResponseType.
     * 
     * @param extension
     */
    ...
    /**
     * Gets the _any value for this FindLinksResponseType.
     * 
     * @return _any
     */
    ...
    /**
     * Sets the _any value for this FindLinksResponseType.
     * 
     * @param _any
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof FindLinksResponseType)) return false;
        FindLinksResponseType other = (FindLinksResponseType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(FindLinksResponseType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://avid.com/interplay/ws/assets/types", "FindLinksResponseType"));
