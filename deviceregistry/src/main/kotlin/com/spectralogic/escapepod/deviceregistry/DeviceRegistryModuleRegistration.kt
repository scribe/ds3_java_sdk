...
class DeviceRegistryModuleRegistration : ModuleRegistration<DeviceRegistryServiceProvider> {
    override fun module(): Class<DeviceRegistryServiceProvider> = DeviceRegistryServiceProvider::class.java
